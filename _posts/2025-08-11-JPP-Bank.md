...
* 카카오 키워드 검색 + 자동완성 기능으로 서울 내 장소 검색
* Turf.js로 서울 행정 경계를 계산해 경계 밖 결과는 필터링

#### AI 장소 추천

* 현재 위치 주변의 관광지, 맛집, 숙박 등을 Spring 백엔드(/api/recommend)를 통해 AI 기반으로 추천
* 카테고리(관광지/문화시설/숙박/음식점 등 8종) 필터 지원
